...
public class Scenarios {
	...
	//by Avinash Chatlani
	public static void runAllScenario4()
	{
		//for (Integer n=1; n<=SCENARIO_COUNT; n++) {
			restartTransactionSystem();
			scenario(4);//10, 12, 20
	...
	//by Avinash Chatlani
	public static void runAllScenario10()
	{
		//for (Integer n=1; n<=SCENARIO_COUNT; n++) {
			restartTransactionSystem();
			scenario(10);//10, 12, 20
		//}					
	}
	//by Avinash Chatlani
	public static void runAllScenario12()
	{
		//for (Integer n=1; n<=SCENARIO_COUNT; n++) {
			restartTransactionSystem();
			scenario(12);//10, 12, 20
		//}					
	}
	//by Avinash Chatlani
	public static void runAllScenario20()
	{
		//for (Integer n=1; n<=SCENARIO_COUNT; n++) {
			restartTransactionSystem();
			scenario(20);//10, 12, 20
		//}					
	}
}
